  ...
  return (
    <ImageBackground
      ...
      <ScrollView
        ...
        <CustomButton
          onPress={() => navigation.navigate('SearchResults', {myPets})}
          buttonText={'Search for pet sitters'}
          style={{
            marginTop: 10,
            marginBottom: 20,
            width: wp('90%'),
          ...
          myPets.map((eachPet, index) => {
            return (
              <TouchableOpacity
                ...
                //     pet_category: eachPet.cat_name,
                //     pet_service: eachPet.pet_purpose_type,
                //     pet_id: eachPet._id,
                //   })
                // }
                activeOpacity={0.6}
